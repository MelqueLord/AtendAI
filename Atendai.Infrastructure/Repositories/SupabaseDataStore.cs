...
public sealed partial class SupabaseDataStore
{
    ...
    public async Task<ManagedUserResponse?> UpdateManagedUserAsync(Guid userId, UserUpdateRequest request, CancellationToken cancellationToken = default)
    {
        ...
        {
            payload["password_hash"] = PasswordHasher.HashPassword(request.Password.Trim());
        }
    ...
    public Task UpdateConversationCustomerNameAsync(Guid tenantId, Guid conversationId, string customerName, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<string?> GetConversationTransportAsync(Guid tenantId, Guid conversationId, CancellationToken cancellationToken = default)
    {
        ...
        var status = rows.FirstOrDefault()?.Status;
    ...
    private static Conversation MapConversation(ConversationRow row, List<MessageRow> messages, string? transport = null)
    {
